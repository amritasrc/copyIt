...
import { FiArrowLeft, FiHeart, FiPlus, FiSearch } from "react-icons/fi";
                ...
                <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-neutral-500">
                            The snippets you&apos;ve favorited, in one place.
                        </p>
                    </div>
                ...
                <div className="mt-6 space-y-3">
                    {filteredSnippets.length === 0 ? (
                        <div className="rounded-xl border border-stone-200 bg-white px-6 py-12 text-center shadow-sm">
                            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-xl bg-violet-50 text-violet-600">
                            ...
                            {snippets.length === 0 ? (
                                <>
                                    ...
                                    <p className="mt-1.5 text-sm text-neutral-500">
                                        Star snippets you love and they&apos;ll
                                        show up here.
                                    </p>
