...
const SnippetCard = ({ id, title, description, lang, code, onDelete }) => {
  return (
    <div className="flex flex-col justify-between rounded-xl bg-zinc-200 p-5 shadow-sm transition hover:border-indigo-500 hover:shadow-lg">
      <div>
        ...
        <pre className="overflow-x-auto rounded-lg bg-zinc-100 p-3 text-sm text-zinc-500">
          <code>{code}</code>
        </pre>
      </div>
